                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('posts.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control @error('id_kategori') is-invalid @enderror" name="id_kategori" value="{{ old('id_kategori'), $post->id_kategori}} }}" placeholder="Masukkan Kategori"> 
                                <option value="">-Pilih Kategori-</option>
                                    @foreach ($kategori_level as $item)
                                    <option value="{{$item->id_kategori}}" {{old('id_kategori',$post->id_kategori) == $item->id_kategori ? 'selected' : null}}>{{$item->kategori}}</option>
                                    @endforeach
                                </select>
